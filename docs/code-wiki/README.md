...
| 版本 | 文件 | 适合场景 | 规模 |
|------|------|---------|------|
| **综合版** | [**Code-Wiki-综合文档.md**](Code-Wiki-综合文档.md) | 通读学习、离线查阅、打印导出（单一文件全文检索） | 单文件 4300+ 行，四大部分 16 章 + 附录 |
| 分章版 | 01-16 各独立文件 | 按需查阅、多人协作（章节粒度编辑冲突最小） | 16 文件，单文件 200~800 行 |

> 两个版本内容等价，更新时互为同步。综合版 = 分章版 16 篇按序合并 + 去重衔接处理。
